...
import { RiArrowRightLine, RiFlashlightLine, RiSparkling2Line } from "react-icons/ri";
...
try {
 ...
 setUserData(result.data)
  ...
  setErr(
    ...
    error.message ||
    "Sign in failed. Make sure backend is running on http://localhost:8000."
  )
}
    }
  return (
    <div className='relative min-h-screen overflow-hidden text-white'>
      ...
      <div className='relative z-10 flex min-h-screen items-center justify-center px-4 py-6 sm:px-6'>
        <form className='glass-panel glow-border relative flex w-full max-w-[460px] flex-col gap-5 overflow-hidden rounded-[32px] px-6 py-7 sm:px-8 sm:py-8' onSubmit={handleSignIn}>
          ...
          <div className='relative z-10 flex flex-col gap-5'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                ...
                <h1 className='mt-1 text-3xl font-semibold text-white'>Sign In</h1>
              </div>
            </div>
            ...
            <button
              className='inline-flex h-14 items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-400 to-blue-500 px-6 text-base font-semibold text-slate-950 transition hover:scale-[1.01] disabled:cursor-not-allowed disabled:opacity-70'
              disabled={loading}
            >
            ...
            <p className='text-center text-sm text-slate-300'>
              ...
              <button className='font-semibold text-cyan-300 transition hover:text-cyan-200' onClick={()=>navigate("/signup")} type="button">
                Sign Up
              </button>
            </p>
          </div>
